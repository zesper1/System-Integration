...
// Prepare the SQL query to fetch violations that can be appealed
$query = "SELECT v.violation_ID, vt.violationTypeName 
          FROM violation v 
          JOIN violationtype vt ON v.violationType_ID = vt.violationType_ID 
          WHERE v.violator_ID = ?"; // Adjusted to check violator_ID
...
<body>
    <div class="container">
        <div class="student">
            <div class="inf1">
                <div class="logo">
                    <img src="../../../public/assets/images/NU_shield.svg.png" class="pic" alt="University Logo">
                    <label class="NU">NATIONAL UNIVERSITY</label> 
                </div> 
            </div>
            <div class="inf">
                <div class="info2">
                    <img src="../../../public/assets/images/bell.png" class="toplogo" alt="Notifications">
                    <img src="../../../public/assets/images/settings.png" class="toplogo" alt="Settings">
                </div>
            </div>
        </div>
        ...
        <div class="con2">
            <div class="sidebar">
                ...
                <div class="dashboard">
                    <a href="dashboardstudent.php" class="dashB">
                        <img src="../../../public/assets/images/dashboard.png" class="dashPIC" alt="Dashboard">
                        <label class="txtR"> VIEW VIOLATIONS</label>
                    </a>
                    <a href="reportstudent.php" class="dashB">
                        <img src="../../../public/assets/images/report.png" class="dashPIC" alt="Report">
                        <label class="txtR"> WRITE A REPORT</label>
                    </a>
                    <a href="appealStudent.php" class="dashB">
                        <img src="../../../public/assets/images/gavel-xl.png" class="dashPIC" alt="Appeal">
            ...
            <div class="content">
                <div class="content1">
                    <div class="col">
                        <div class="text">
                            <label class="hello"> APPEAL TO A VIOLATION</label>
                        </div>
                    </div>
                </div>
                        ...
                        <?php if ($hasViolations): ?>
                            <?php foreach ($violations as $violation): ?>
                                <option value="<?php echo $violation['violation_ID']; ?>">
                                    <?php echo htmlspecialchars($violation['violationTypeName']); ?>
                                </option>
                            <?php endforeach; ?>
                        <?php else: ?>
