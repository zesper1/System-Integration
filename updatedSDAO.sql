...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 19, 2024 at 08:53 AM
...
INSERT INTO `faculty` (`fac_id`, `last_name`, `first_name`, `middle_name`, `dept`) VALUES
(2020172123, '', '', '', 'SECA'),
(2022171000, '', '', '', 'SECA'),
(2022171107, 'smith', 'john', 'guzman', 'CIT');
...
(2022171105, 2, 'ASA@gmail.com', '$2y$10$kgItQ8KTaZRTnbn0Tf0gWuzb6xhuj8/jCWrMThhPMaH'),
(2022171107, 2, 'smith@gmail.com', '$2y$10$/r.rrMrM2poQwYscgKUaR.uc/eKZa9VbSWvHypqx6U3');
...
--
ALTER TABLE `faculty`
  MODIFY `fac_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2022171108;
...
--
ALTER TABLE `user`
  MODIFY `user_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2022171108;
