    ...
    <div class="container">
        ...
        <div class="sidebar">
            ...
            <div class="dashboard">
                ...
                <div class="dashB">
                    <img src="../PHPLOGIN/images/write.png" class="dashPIC"/>
        ...
        <div class="students">     
             <div class="all">
                ...
                <div class="up">
                    <div class="report">
                        <img src="../PHPLOGIN/images/NU_shield.svg.png" class="pic3" >
                    </div>
                    <div class="baba">
                    <p> Student Name: Rovic Batacandolo <br>
                        Student ID:  2022-171700 <br>
                        Violation:    Public Display of Affection </p>
                </div>
                </div>
                ...
                <div class="case">
                        ...
                        <p> Rovic Batacandolo was caught with his significant <br>
                        kissing near the fire exit around 3:09 pm, dated <br>
                        August 30, 2024. The report was submitted  <br>
                        by an admin and the ID of the reported student <br>
                        was confiscated.
                    </p>
                </div>
                </div>
